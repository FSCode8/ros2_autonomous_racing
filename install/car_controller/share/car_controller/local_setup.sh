...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_autonomous_racing/src/install/car_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_controller/environment/path.sh"
